...
/** A tagged coproduct A ⊕ B with injections */
...
/** Coequalizer of r,s: X ⇉ Y (quotient Y/~ generated by r(x) ~ s(x)) */
...
/** Pushout of f:A→B and g:A→C:  B ⊔_A C = coeq( B⊕C ⇉ B⊕C ) */
...
export function verifyCoproductUniversal<A, B, Z>(
  ...
  // Construct mediating morphism [fA, fB]: A ⊕ B → Z
...
export function demonstrateFinSetColimits() {
  ...
  console.log("\\nColimit Types:");
  console.log("  • Coproduct: A ⊕ B with injections inl, inr");
  console.log("  • Coequalizer: Y/~ where r(x) ~ s(x)");
  console.log("  • Pushout: B ⊔_A C along span B ← A → C");
  
  console.log("\\nUniversal Properties:");
  console.log("  • Coproduct: [f, g]: A ⊕ B → Z mediating morphism");
  ...
  console.log("  • Gluing constructions in topology");
