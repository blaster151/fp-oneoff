...
export class GroupHom<G, H> {
  ...
  kernel(): NormalSubgroup<G> {
    ...
    // TODO: Add runtime verification that this is actually a homomorphism
  ...
  imagePredicate(): (h: H) => boolean {
    ...
    // TODO: Implement finite search strategy for small groups
    // - For finite G, we can enumerate all elements and check f(g) = h
    // - Should add a helper method that takes a finite list of G elements
    // - This would make the image predicate actually useful for small examples
